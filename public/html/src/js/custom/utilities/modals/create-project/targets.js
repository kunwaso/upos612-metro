...
var KTModalCreateProjectTargets = function () {
	...
	var initForm = function() {
		...
		var tagsInput = form.querySelector('[name="target_tags"]');
		if (tagsInput) {
			var tags = new Tagify(tagsInput, {
		...
		var dueDateInput = form.querySelector('[name="target_due_date"]');
		if (dueDateInput) {
			var dueDateOptions = {
				enableTime: true,
			...
			if (typeof window.flatpickr === 'function') {
				window.flatpickr(dueDateInput, dueDateOptions);
			} else if (typeof $ === 'function' && $.fn && typeof $.fn.flatpickr === 'function') {
				$(dueDateInput).flatpickr(dueDateOptions);
			}
		}

		// Expiry year. For more info, plase visit the official plugin site: https://select2.org/
		var assignInput = form.querySelector('[name="target_assign"]');
		if (assignInput) {
