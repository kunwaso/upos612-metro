...
var KTHeaderGlobalSearch = function () {
    var element;
    var inputElement;
    ...
    var renderResults = function (items) {
        ...
        items.forEach(function (item) {
            ...
            textNode.textContent = item && item.text ? item.text : "Untitled";
    ...
    return {
        init: function () {
            element = document.querySelector("#kt_header_global_search");
            ...
            templateElement = element.querySelector("#kt_header_global_search_result_template");
