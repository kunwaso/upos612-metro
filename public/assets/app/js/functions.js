...
function __currency_trans_from_en(
    ...
    if (
        ...
        if (
            ...
            __p_currency_thousand_separator !== null
        ) {
            thousand = __p_currency_thousand_separator;
        }
        if (
            typeof __p_currency_decimal_separator !== 'undefined' &&
            __p_currency_decimal_separator !== null
        ) {
            decimal = __p_currency_decimal_separator;
        }
    } else {
        if (typeof __currency_symbol !== 'undefined' && __currency_symbol !== null) {
            s = __currency_symbol;
        }
        if (
            typeof __currency_thousand_separator !== 'undefined' &&
            __currency_thousand_separator !== null
        ) {
            thousand = __currency_thousand_separator;
        }
        if (
            typeof __currency_decimal_separator !== 'undefined' &&
            __currency_decimal_separator !== null
        ) {
    ...
    if (show_symbol) {
        ...
        format = '%s %v';
        if (
            typeof __currency_symbol_placement !== 'undefined' &&
            __currency_symbol_placement == 'after'
        ) {
            format = '%v %s';
        }
    }
