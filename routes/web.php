...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone'])->group(function () {
    ...
    Route::post('/two-factor/challenge/recovery', [TwoFactorChallengeController::class, 'verifyRecoveryCode'])->name('two-factor.challenge.recovery');

    Route::post('/users/{user}/two-factor/setup', [UserTwoFactorController::class, 'startSetup'])
        ->whereNumber('user')
        ->name('users.two-factor.setup.start');
    Route::post('/users/{user}/two-factor/confirm', [UserTwoFactorController::class, 'confirmSetup'])
        ->whereNumber('user')
        ->name('users.two-factor.setup.confirm');
    Route::post('/users/{user}/two-factor/disable', [UserTwoFactorController::class, 'disableSelf'])
        ->whereNumber('user')
        ->name('users.two-factor.disable');
    Route::post('/users/{user}/two-factor/reset', [UserTwoFactorController::class, 'resetForUser'])
        ->whereNumber('user')
        ->name('users.two-factor.reset');
    Route::get('/users/{user}/two-factor/recovery-codes/{token}', [UserTwoFactorController::class, 'downloadRecoveryCodes'])
        ->whereNumber('user')
        ->name('users.two-factor.recovery.download');
});

Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'two_factor.verified', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/home/metronic-dashboard-data', [HomeController::class, 'getMetronicDashboardData']);
    ...
    Route::resource('payment-account', 'PaymentAccountController')
        ->middleware(RedirectLegacyAccountingToVas::class);
    ...
    Route::prefix('product/quotes')->name('product.quotes.')->group(function () {
        ...
        Route::get('/create', [ProductQuoteController::class, 'create'])->name('create');
        Route::post('/', [ProductQuoteController::class, 'store'])->name('store');
        Route::get('/{id}', [ProductQuoteController::class, 'show'])->whereNumber('id')->name('show');
        Route::get('/{id}/edit', [ProductQuoteController::class, 'edit'])->whereNumber('id')->name('edit');
        Route::match(['put', 'patch'], '/{id}', [ProductQuoteController::class, 'update'])->whereNumber('id')->name('update');
        Route::delete('/{id}', [ProductQuoteController::class, 'destroy'])->whereNumber('id')->name('destroy');
        Route::post('/{id}/revert-draft', [ProductQuoteController::class, 'revertToDraft'])->whereNumber('id')->name('revert_draft');
        Route::post('/{id}/clear-signature', [ProductQuoteController::class, 'clearSignature'])->whereNumber('id')->name('clear_signature');
        Route::post('/{id}/send', [ProductQuoteController::class, 'send'])->whereNumber('id')->name('send');
        Route::post('/{id}/public-password', [ProductQuoteController::class, 'setPublicPassword'])->whereNumber('id')->name('set_public_password');
        Route::get('/{id}/sell-prefill', [ProductQuoteController::class, 'sellPrefill'])->whereNumber('id')->name('sell_prefill');
        Route::post('/{id}/release-invoice', [ProductQuoteController::class, 'releaseInvoice'])->whereNumber('id')->name('release_invoice');
    });

    Route::prefix('product/sales/orders')->name('product.sales.orders.')->group(function () {
        Route::get('/', [ProductSalesOrderController::class, 'index'])->name('index');
        Route::get('/product-search', [ProductSalesOrderController::class, 'productSearch'])->name('product_search');
        Route::get('/{id}/edit', [ProductSalesOrderController::class, 'edit'])->whereNumber('id')->name('edit');
        Route::match(['put', 'patch'], '/{id}', [ProductSalesOrderController::class, 'update'])->whereNumber('id')->name('update');
        Route::delete('/{id}', [ProductSalesOrderController::class, 'destroy'])->whereNumber('id')->name('destroy');
        Route::get('/{id}', [ProductSalesOrderController::class, 'show'])->whereNumber('id')->name('show');
        Route::patch('/{id}/hold', [ProductSalesOrderController::class, 'updateHoldStatus'])->whereNumber('id')->name('hold.update');
    });
...
Route::middleware(['setData'])->group(function () {
    Route::get('/q/{publicToken}', [PublicQuoteController::class, 'show'])
        ->name('product.quotes.public');
    Route::post('/q/{publicToken}/unlock', [PublicQuoteController::class, 'unlock'])
        ->middleware('throttle:6,1')
        ->name('product.quotes.public.unlock');
    Route::post('/q/{publicToken}/confirm', [PublicQuoteController::class, 'confirm'])
        ->name('product.quotes.public.confirm');
});
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'two_factor.verified'])->group(function () {
