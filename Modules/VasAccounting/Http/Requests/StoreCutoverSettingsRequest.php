...
class StoreCutoverSettingsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'cutover_settings.family_modes' => ['nullable', 'array'],
            'cutover_settings.family_modes.*' => ['string', Rule::in(['legacy', 'pilot', 'native', 'bridge'])],
            ...
            'rollout_settings.enabled_document_families' => ['nullable', 'array'],
            'rollout_settings.enabled_document_families.*' => ['string'],
