...
@section('content')
    ...
    @include('vasaccounting::partials.header', [
        ...
        'subtitle' => 'Vendor bill allocations, aging exposure, and payment availability from posted VAS vouchers.',
    ])
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table align-middle table-row-dashed fs-7 gy-4">
                            <thead><tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0"><th>Bill</th><th>Vendor</th><th>Posting Date</th><th>Outstanding</th><th>Age</th></tr></thead>
                            <tbody>
        ...
        <div class="col-xl-6">
            <div class="card card-flush h-100">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table align-middle table-row-dashed fs-7 gy-4">
                            <thead><tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0"><th>Payment</th><th>Vendor</th><th>Available</th></tr></thead>
                            <tbody>
        ...
        <div class="col-xl-6">
            <div class="card card-flush h-100">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table align-middle table-row-dashed fs-7 gy-4">
                            <thead><tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0"><th>Date</th><th>Vendor</th><th>Bill</th><th>Payment</th><th>Amount</th></tr></thead>
                            <tbody>
