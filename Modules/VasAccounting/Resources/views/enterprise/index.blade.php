...
@section('content')
    ...
    <div class="row g-5 g-xl-10 mb-8">
        ...
        <div class="col-md-3">
            <div class="card card-flush h-100">
                <div class="card-body">
                    <div class="text-gray-700 fw-semibold fs-7 mb-2">Posted vouchers</div>
        ...
        <div class="col-md-3">
            <div class="card card-flush h-100">
                <div class="card-body">
                    <div class="text-gray-700 fw-semibold fs-7 mb-2">Workflow backlog</div>
        ...
        <div class="col-md-3">
            <div class="card card-flush h-100">
                <div class="card-body">
                    <div class="text-gray-700 fw-semibold fs-7 mb-2">Connected adapters</div>
        ...
        <div class="col-xl-7">
            <div class="card card-flush h-100">
                <div class="card-header">
                    <div class="card-title">Planned capabilities</div>
                </div>
                <div class="card-body">
                    <div class="row g-4">
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-row-dashed fs-6 gy-5">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="3" class="text-muted">No vouchers posted for this enterprise area yet.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
