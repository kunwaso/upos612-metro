...
@section('title', __('vasaccounting::lang.views.invoices.form.page_title_edit'))
...
@section('content')
    ...
    @include('vasaccounting::partials.header', [
        'title' => __('vasaccounting::lang.views.invoices.form.header_edit_title'),
        'subtitle' => $document->voucher_no ?? __('vasaccounting::lang.views.invoices.form.header_edit_subtitle_fallback'),
    ])
    ...
    <div class="row g-5 g-xl-10">
                    ...
                    <form method="POST" action="{{ route('vasaccounting.invoices.update', $document->id) }}">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex gap-3">
                                <button type="submit" name="action" value="save_draft" class="btn btn-light-primary">{{ __('vasaccounting::lang.views.invoices.form.update_draft') }}</button>
        ...
        <div class="col-xl-4">
            <div class="card card-flush mb-5">
                ...
                <div class="card-body">
                    <div class="text-muted fs-7 mb-3">{{ __('vasaccounting::lang.views.invoices.form.workflow_note_edit_1') }}</div>
                    <div class="text-muted fs-7 mb-3">{{ __('vasaccounting::lang.views.invoices.form.workflow_note_edit_2') }}</div>
                    <div class="text-muted fs-7">{{ __('vasaccounting::lang.views.invoices.form.workflow_note_edit_3') }}</div>
                </div>
            </div>
        </div>
    </div>
