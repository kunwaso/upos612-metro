...
@section('title', __('lang_v1.putaway_document'))
...
<div class="d-flex flex-column flex-column-fluid">
    ...
    >
        <x-slot name="contextActions">
                ...
                <a href="{{ route('storage-manager.inbound.index') }}" class="btn btn-sm btn-light-primary">@lang('lang_v1.inbound_receiving')</a>
