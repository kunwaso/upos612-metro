    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">@lang('lang_v1.cycle_count_sessions')</h1>
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3"><a href="{{ route('storage-manager.control-tower.index') }}" class="btn btn-sm btn-light">@lang('lang_v1.control_tower')</a><a href="{{ route('storage-manager.damage.index') }}" class="btn btn-sm btn-light-primary">@lang('lang_v1.damage_quarantine')</a></div>
        </div>
    </div>
