...
@section('title', 'Transfer Dispatch')
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">Transfer Dispatch</li>
                </ul>
            </div>
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <a href="{{ route('storage-manager.transfers.index') }}" class="btn btn-sm btn-light">@lang('messages.back')</a>
                <a href="{{ route('storage-manager.transfers.receipts.show', $document->source_id) }}" class="btn btn-sm btn-light-primary">Receipt Workbench</a>
            </div>
        </div>
    </div>
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card card-flush mb-6">
                ...
                <div class="card-body pt-0">
                    <div class="row g-5">
                        <div class="col-md-4">
                            <div class="text-gray-500 fs-7">Transfer Reference</div>
                            <div class="fw-semibold text-gray-900">{{ $sourceSummary['source_ref'] ?? '-' }}</div>
                        </div>
                        <div class="col-md-4">
            ...
            @if(auth()->user()->can('storage_manager.operate') && !empty($sourceSummary['can_confirm']))
                <form method="POST" action="{{ route('storage-manager.transfers.dispatch.confirm', $document->id) }}">
                    @csrf
                    <div class="card card-flush">
                        <div class="card-header pt-6">
                            <h3 class="card-title fw-bold text-gray-900">Dispatch Lines</h3>
                            <div class="card-toolbar">
                                <button type="submit" class="btn btn-sm btn-primary">Confirm Dispatch</button>
                            </div>
                        </div>
                        <div class="card-body pt-0">
                            <div class="table-responsive">
                                <table class="table table-row-dashed align-middle">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="9" class="text-center text-muted py-8">No dispatch lines.</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
            ...
            @else
                <div class="alert alert-info">
                    Dispatch is not ready for confirmation.
                </div>
                <div class="card card-flush">
                    <div class="card-body pt-0">
                        <div class="table-responsive">
                            <table class="table table-row-dashed align-middle">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="8" class="text-center text-muted py-8">No dispatch lines.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
