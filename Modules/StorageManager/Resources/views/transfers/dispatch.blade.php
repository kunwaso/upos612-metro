...
@section('title', __('lang_v1.transfer_dispatch'))
...
<div class="d-flex flex-column flex-column-fluid">
    ...
    >
        <x-slot name="contextActions">
                ...
                <a href="{{ route('storage-manager.transfers.receipts.show', $document->source_id) }}" class="btn btn-sm btn-light-primary">@lang('lang_v1.receipt_workbench')</a>
        </x-slot>
    </x-storagemanager::storage-toolbar>
