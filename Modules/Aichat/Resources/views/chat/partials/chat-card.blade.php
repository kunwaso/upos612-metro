    ...
    <div class="card-header pe-5" id="kt_drawer_chat_messenger_header">
        <div class="card-title">
            <div class="d-flex justify-content-center flex-column me-3">
                <span class="fs-4 fw-bold text-gray-900 mb-1 lh-1">{{ __('aichat::lang.ai_assistant') }}</span>
                <span class="fs-7 fw-semibold text-muted">{{ __('aichat::lang.ai_chat') }}</span>
            </div>
        </div>
        <div class="card-toolbar d-flex align-items-center gap-2 flex-wrap">
            @if(!empty($chatConfig['permissions']['can_use_quote_wizard']) && !empty($chatConfig['features']['quote_wizard_enabled']))
            ...
            <div class="me-0">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-250px py-3" data-kt-menu="true">
                    <div class="menu-item px-3">
                        <div class="menu-content text-muted pb-2 px-3 fs-7 text-uppercase">{{ __('aichat::lang.ai_chat') }}</div>
                    </div>
                    <div class="menu-item px-3">
                        <button type="button" class="menu-link px-3 w-100 border-0 bg-transparent text-start" data-chat-new-conversation>
                            {{ __('aichat::lang.chat_start_new_chat') }}
                        </button>
                    </div>
                    <div class="menu-item px-3">
                        <div class="menu-content text-muted pb-2 px-3 fs-7 text-uppercase">{{ __('aichat::lang.chat_conversations') }}</div>
                    ...
                    <div class="menu-item px-3">
                        <a href="{{ route('aichat.chat.index') }}" class="menu-link px-3">{{ __('aichat::lang.ai_chat') }}</a>
                    </div>
                    @can('aichat.chat.settings')
                        <div class="menu-item px-3">
                            <a href="{{ route('aichat.chat.settings') }}" class="menu-link px-3">{{ __('aichat::lang.chat_settings') }}</a>
                        </div>
                    @endcan
                </div>
            </div>
