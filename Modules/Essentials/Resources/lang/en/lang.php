...
return [
    ...
    'manage_transcripts'          => 'Record or upload audio and save transcripts',
    'new_transcript'              => 'New Transcript',
    'upload_audio'                => 'Upload Audio File',
    'record_live'                 => 'Record Live',
    'start_recording'             => 'Start Recording',
    'stop_transcribe'             => 'Stop & Transcribe',
    'recording'                   => 'Recording…',
    ...
    'transcript_title_placeholder'=> 'e.g. Sales call with client',
    'transcript_preview'          => 'Preview',
    'translated_preview'          => 'Translated Preview',
    ...
    'transcribing_please_wait'    => 'Transcribing, please wait…',
    'translating_please_wait'     => 'Translating, please wait...',
    'copy'                        => 'Copy',
    'copied'                      => 'Copied to clipboard',
    'audio_required'              => 'Please upload an audio file or record from the microphone.',
    'audio_invalid_format'        => 'Unsupported audio format. Supported: mp3, wav, m4a, webm, ogg, flac.',
    'audio_too_large'             => 'Audio file must not exceed 25 MB.',
    'audio_format_help'           => 'Supported: mp3, wav, m4a, webm, ogg, flac (max 25 MB)',
    'translation_engine'          => 'Translation Engine',
    'translation_engine_py_googletrans' => 'py-googletrans (free)',
    'translation_engine_aichat'   => 'Aichat provider/model',
    'translation_engine_help'     => 'Choose how transcript text is translated. py-googletrans is the default and does not require Aichat credentials.',
    'groq_api_key'                => 'Groq API Key (for Voice Transcripts)',
    'groq_api_key_placeholder'    => 'gsk_••••••••••••••••',
    'groq_api_key_help'           => 'Get your free API key from <a href="https://console.groq.com" target="_blank">console.groq.com</a>. Used for the Voice Transcript feature.',
    'groq_api_key_saved'          => 'A Groq API key is currently saved for this business.',
    'groq_api_key_missing'        => 'Groq API key is not configured. Please set it in HRM Settings → Voice Transcripts.',
    'translation_py_runtime_missing' => 'Python runtime is not available on the server. Please install Python or update transcript translator settings.',
    'translation_py_script_missing' => 'Transcript translation script is missing on the server.',
    'translation_py_dependency_missing' => 'Python dependency py-googletrans is missing. Please install transcript translation requirements.',
    'translation_py_timeout'      => 'Transcript translation request timed out. Please try again.',
    'translation_py_language_unsupported' => 'Selected language pair is not supported by the translator.',
    'translation_py_failed'       => 'Transcript translation failed. Please try again.',
    'mic_not_supported'           => 'Your browser does not support microphone recording.',
    'mic_permission_denied'       => 'Microphone permission was denied. Please allow mic access in your browser.',
    'language_required'           => 'Please select source and target languages.',
    'language_invalid'            => 'Selected language is invalid.',
    'source_required'             => 'Transcript source is required.',
    'source_invalid'              => 'Transcript source is invalid.',
    'transcript_text_required'    => 'Transcript text is required before saving.',
    'translated_text_required'    => 'Translated text is required before saving.',
    'translation_text_required'   => 'Text is required for translation.',
    'translation_provider_unavailable' => 'Selected translation provider is not configured for this business.',
    'translation_provider_key_missing' => 'No active AI provider key found for Aichat translation. Please configure Aichat credentials or switch to py-googletrans.',
    'translation_empty_response'  => 'Translation provider returned an empty response.',
    'transcript_preview_ready'    => 'Transcript preview is ready. Review and choose Save or Discard.',
    'translation_ready'           => 'Translation updated.',
    'preview_translate'           => 'Preview & Translate',
    'save_transcript'             => 'Save Transcript',
    'discard_transcript'          => 'Discard',
    'recording_discarded'         => 'Recording preview was discarded.',
    'recording_saved'             => 'Recording saved successfully.',
    'save_confirm_title'          => 'Save this transcript?',
    'save_confirm_description'    => 'Review transcript and translation. Save to keep this record or discard to remove it.',
    'live_transcript_unavailable' => 'Live transcript is not supported in this browser. Recording will still work and transcript will appear after Stop.',
    'recording_in_progress'       => 'Recording in progress',
    'live_translation_updating'   => 'Updating live translation...',
];
