                ...
                <div class="tab-content">
                    @can('essentials.crud_all_attendance')
                        <div class="tab-pane active" id="shifts_tab">
                            <button type="button" class="inline-block py-[10px] px-[30px] bg-primary-500 text-white transition-all hover:bg-primary-400 rounded-md border border-primary-500 hover:border-primary-400 pull-right"
                    ...
                    <div class="tab-pane @if(!auth()->user()->can('essentials.crud_all_attendance')) active @endif" id="attendance_tab">
                        <div class="row">
                            ...
                            <button type="button" class="btn btn-sm btn-primary btn-modal pull-right float-end d-inline-flex align-items-center"
                                ...
                                <i class="ki-outline ki-plus fs-3 me-2"></i>@lang('essentials::lang.add_latest_attendance')
                            </button>
                            </div>
                            @endcan
                        </div>
