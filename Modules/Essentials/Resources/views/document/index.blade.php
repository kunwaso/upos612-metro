	...
	<h4 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">
		...
		<div class="box box-solid">
			...
			<div class="box-tools pull-right">
				<button type="button" class="inline-block py-[10px] px-[30px] bg-primary-500 text-white transition-all hover:bg-primary-400 rounded-md border border-primary-500 hover:border-primary-400 pull-righ add_doc">
