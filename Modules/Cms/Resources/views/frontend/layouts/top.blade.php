                ...
                <div class="header-language-icon widget fs-13 alt-font fw-600">
                    <div class="header-language dropdown">
                        ...
                        <ul class="language-dropdown alt-font">
                            ...
                            <li><a href="javascript:void(0);" title="France"><span class="icon-country"><img src="{{ asset('modules/cms/assets/images/country-flag-16X16/vietnam.png') }}" alt="" data-no-retina=""></span>Vietnamese</a></li>
                        </ul>
                    </div>
                </div>
            </div>
