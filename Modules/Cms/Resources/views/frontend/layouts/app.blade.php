...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('modules/cms/assets/decor-store/decor-store.css') }}"/>
                            ...
                            <div class="header-language-icon widget fs-13 alt-font fw-600">
                                <div class="header-language dropdown">
                                    ...
                                    <ul class="language-dropdown alt-font">
                                        <li><a href="javascript:void(0);" title="English"><span class="icon-country"><img src="{{ asset('modules/cms/assets/images/country-flag-16X16/usa.png') }}" alt="" data-no-retina=""></span>English</a></li> 
                                        <li><a href="javascript:void(0);" title="France"><span class="icon-country"><img src="{{ asset('modules/cms/assets/images/country-flag-16X16/france.png') }}" alt="" data-no-retina=""></span>France</a></li>
                                        <li><a href="javascript:void(0);" title="Russian"><span class="icon-country"><img src="{{ asset('modules/cms/assets/images/country-flag-16X16/russian.png') }}" alt="" data-no-retina=""></span>Russian</a></li>
                                        <li><a href="javascript:void(0);" title="Spain"><span class="icon-country"><img src="{{ asset('modules/cms/assets/images/country-flag-16X16/spain.png') }}" alt="" data-no-retina=""></span>Spain</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <ul class="cart-item-list">
                                        <li class="cart-item align-items-center">
                                            ...
                                            <div class="product-image">
                                                <a href="demo-decor-store-single-product.html"><img src="https://placehold.co/600x700" class="cart-thumb" alt=""></a>
                                            </div>
        ...
        <!-- end section -->
        <!-- start footer -->
        <footer class="footer-dark bg-dark-gray pb-0 pt-0 cover-background" style="background-image:url('{{ asset('modules/cms/assets/images/demo-decor-store-footer-bg.jpg') }}')">
