...
class SalesOrderEditUtil
{
    ...
    public function __construct(TransactionUtil $transactionUtil, ?ProjectXNumberFormatUtil $numberFormatUtil = null)
    {
        $this->transactionUtil = $transactionUtil;
        $this->numberFormatUtil = $numberFormatUtil;
    }

    public function getProjectxSellTransactionForEdit(int $businessId, int $id): Transaction
    {
    ...
    protected function fetchQuoteForTransaction(int $businessId, int $transactionId): Quote
    {
        return Quote::forBusiness($businessId)
    ...
    {
        $dropdown = TaxRate::forBusinessDropdown($businessId, true, true);

        return [
            'tax_rates' => $this->normalizeArrayLike($dropdown['tax_rates'] ?? []),
            'attributes' => $this->normalizeArrayLike($dropdown['attributes'] ?? []),
        ];
    }
    ...
    {
        return $this->normalizeArrayLike(Contact::customersDropdown($businessId, false, true));
    }

    protected function fetchLocationsDropdown(int $businessId): array
    {
        return $this->normalizeArrayLike(BusinessLocation::forDropdown($businessId, false, false));
    }

    protected function normalizeArrayLike($value): array
    {
