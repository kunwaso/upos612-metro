...
{
    protected $signature = 'projectx:chat-prune {--business_id=} {--dry-run}';

    protected $description = 'Prune ProjectX chat conversations older than configured retention policy.';
