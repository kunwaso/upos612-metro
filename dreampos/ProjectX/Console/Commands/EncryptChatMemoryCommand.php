...
namespace Modules\ProjectX\Console\Commands;
...
{
    protected $signature = 'projectx:encrypt-chat-memory {--business_id=} {--dry-run}';

    protected $description = 'Encrypt plaintext rows in projectx_chat_memory.memory_value';

    public function handle()
    {
        if (! DB::getSchemaBuilder()->hasTable('projectx_chat_memory')) {
            $this->warn('projectx_chat_memory table does not exist.');
        ...
        $query = DB::table('projectx_chat_memory')
