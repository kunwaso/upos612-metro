...
@section('title', __('projectx::lang.fabric_users'))

@section('content')
@include('projectx::fabric_manager._fabric_header')

<div class="d-flex flex-wrap flex-stack pt-10 pb-8">
    <h3 class="fw-bold my-2">{{ __('projectx::lang.fabric_users') }}
        <span class="fs-6 text-gray-500 fw-semibold ms-1">{{ __('projectx::lang.active') }}</span>
    </h3>
    <div class="d-flex flex-wrap my-1">
        <div class="d-flex align-items-center position-relative my-1 me-4">
            ...
            <input type="text" id="kt_filter_search" class="form-control form-control-sm form-control-solid w-150px ps-10" placeholder="{{ __('projectx::lang.search') }}..." />
        </div>
        <ul class="nav nav-pills me-5">
            <li class="nav-item m-0">
                <a class="btn btn-sm btn-icon btn-light btn-color-muted btn-active-primary active me-3" data-bs-toggle="tab" href="#kt_fabric_users_card_pane">
            ...
            <li class="nav-item m-0">
                <a class="btn btn-sm btn-icon btn-light btn-color-muted btn-active-primary" data-bs-toggle="tab" href="#kt_fabric_users_table_pane">
...
<div class="tab-content">
    <div id="kt_fabric_users_card_pane" class="tab-pane fade show active">
                ...
                <div class="card">
                    <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                        <div class="symbol symbol-65px symbol-circle mb-5">
                            <img src="{{ asset('modules/projectx/media/avatars/' . $user['avatar']) }}" alt="image" />
                            @if($user['online'])
                        ...
                        <div class="d-flex flex-center flex-wrap">
                            <div class="border border-gray-300 border-dashed rounded min-w-80px py-3 px-4 mx-2 mb-3">
                                ...
                                <div class="fw-semibold text-gray-500">{{ __('projectx::lang.earnings') }}</div>
                            </div>
                            <div class="border border-gray-300 border-dashed rounded min-w-80px py-3 px-4 mx-2 mb-3">
                                <div class="fs-6 fw-bold text-gray-700">{{ $user['tasks'] }}</div>
                                <div class="fw-semibold text-gray-500">{{ __('projectx::lang.tasks') }}</div>
                            </div>
                            <div class="border border-gray-300 border-dashed rounded min-w-80px py-3 px-4 mx-2 mb-3">
                                <div class="fs-6 fw-bold text-gray-700">{{ $user['sales'] }}</div>
                                <div class="fw-semibold text-gray-500">{{ __('projectx::lang.sales') }}</div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div id="kt_fabric_users_table_pane" class="tab-pane fade">
        <div class="card card-flush">
            <div class="card-body pt-0">
                <table class="table table-row-bordered table-row-dashed gy-4 align-middle fw-bold" id="kt_fabric_users_table">
                    <thead class="fs-7 text-gray-500 text-uppercase">
                        <tr>
                            <th class="min-w-250px">{{ __('projectx::lang.fm_users') }}</th>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-35px symbol-circle me-3">
                                        <img alt="Pic" src="{{ asset('modules/projectx/media/avatars/' . $user['avatar']) }}" />
                                    </div>
...
<script src="{{ asset('modules/projectx/js/custom/apps/projects/users/users.js') }}"></script>
@endsection
