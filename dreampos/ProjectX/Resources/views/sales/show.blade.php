...
@section('page_title', __('projectx::lang.sale_detail'))

@section('breadcrumb_items')
<li class="breadcrumb-item text-gray-600">
    <a href="{{ route('projectx.sales') }}" class="text-gray-600 text-hover-primary">{{ __('projectx::lang.sales') }}</a>
</li>
<li class="breadcrumb-item text-gray-500">{{ $transaction->invoice_no }}</li>
@endsection

@section('toolbar_actions')
<a href="{{ route('projectx.sales') }}" class="btn btn-sm btn-flex btn-light-primary fw-bold">
    <i class="ki-duotone ki-arrow-left fs-5 me-1"><span class="path1"></span><span class="path2"></span></i>
    {{ __('projectx::lang.back_to_dashboard') }}
</a>
@endsection
                    ...
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="text-gray-700 fw-semibold fs-6">@format_quantity((float) $line->quantity)</span>
                                </td>
                                <td>
                                    <span class="text-gray-700 fw-semibold fs-6">@format_currency((float) $line->unit_price_inc_tax)</span>
                                </td>
                                <td>
                                ...
                                <td class="text-end">
                                    <span class="text-gray-900 fw-bold fs-6">
                                        @format_currency((float) ($line->unit_price_inc_tax * $line->quantity))
                                    </span>
                                </td>
                            </tr>
                            @endforeach
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="5" class="text-end fw-bold text-gray-700 fs-6 pe-3">
                                    {{ __('projectx::lang.discount') }}
                                </td>
                                <td class="text-end fw-bold text-gray-800 fs-6">
                                    @format_currency((float) ($transaction->discount_amount ?? 0))
                                </td>
                            </tr>
                            <tr>
                                <td colspan="5" class="text-end fw-bold text-gray-700 fs-6 pe-3">
                                    {{ __('projectx::lang.tax') }}
                                </td>
                                <td class="text-end fw-bold text-gray-800 fs-6">
                                    @format_currency((float) ($transaction->tax_amount ?? 0))
                                </td>
                            </tr>
                            <tr class="border-top border-gray-300">
                                <td colspan="5" class="text-end fw-bolder text-gray-900 fs-4 pe-3">
                                    {{ __('projectx::lang.grand_total') }}
                                </td>
                                <td class="text-end fw-bolder text-gray-900 fs-4">
                                    @format_currency((float) $transaction->final_total)
                                </td>
                            </tr>
                        </tfoot>
                ...
                <div class="table-responsive">
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <span class="badge badge-light-primary">{{ ucfirst($payment->method) }}</span>
                                </td>
                                <td>
                                    <span class="text-gray-900 fw-bold fs-6">
                                        @format_currency((float) $payment->amount)
                                    </span>
                                </td>
                                <td>
                                    <span class="text-gray-700 fw-semibold fs-7">
                                        {{ \Carbon\Carbon::parse($payment->paid_on)->format('M d, Y h:i A') }}
                                    </span>
                                </td>
                            </tr>
                            @endforeach
