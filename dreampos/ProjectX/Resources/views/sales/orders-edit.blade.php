...
@if($errors->any())
    <div class="alert alert-danger mb-6">
        <div class="fw-bold mb-2">{{ __('projectx::lang.validation_failed') }}</div>
        <ul class="mb-0 ps-5">
...
<form method="POST" action="{{ route('projectx.sales.orders.update', ['id' => $transaction->id]) }}" id="projectx_sales_order_edit_form">
    @csrf
    @method('PUT')
    ...
    <div class="card card-flush mb-6">
        <div class="card-header pt-7">
            <h3 class="card-title fw-bold text-gray-900">{{ __('projectx::lang.order_details') }}</h3>
        </div>
        <div class="card-body pt-5">
            <div class="row g-5">
                <div class="col-md-3">
                    <label class="form-label">{{ __('projectx::lang.invoice_no') }}</label>
                    <input type="text" class="form-control form-control-solid" value="{{ $transaction->invoice_no }}" readonly>
                </div>
                <div class="col-md-3">
                    <label class="form-label required">{{ __('projectx::lang.sale_date') }}</label>
                ...
                <div class="col-md-3">
                    <label class="form-label required">{{ __('projectx::lang.status') }}</label>
                ...
                <div class="col-md-3">
                    <label class="form-label">{{ __('projectx::lang.delivery_date') }}</label>
                    <input type="text" class="form-control form-control-solid" id="kt_projectx_orders_edit_delivery_date" name="delivery_date" value="{{ old('delivery_date', $deliveryDate ?? '') }}" placeholder="{{ __('projectx::lang.delivery_date') }}">
                </div>
                <div class="col-md-3">
                    <label class="form-label">{{ __('projectx::lang.pay_term_number') }}</label>
                ...
                <div class="col-md-3">
                    <label class="form-label">{{ __('projectx::lang.pay_term_type') }}</label>
                    <select class="form-select form-select-solid" name="pay_term_type">
                        <option value="">{{ __('projectx::lang.none') }}</option>
                        <option value="days" {{ old('pay_term_type', $transaction->pay_term_type) === 'days' ? 'selected' : '' }}>{{ __('projectx::lang.days') }}</option>
                        <option value="months" {{ old('pay_term_type', $transaction->pay_term_type) === 'months' ? 'selected' : '' }}>{{ __('projectx::lang.months') }}</option>
                    </select>
                </div>
                <div class="col-md-3">
                    <label class="form-label required">{{ __('projectx::lang.customer') }}</label>
                    <select class="form-select form-select-solid" data-control="select2" data-placeholder="{{ __('projectx::lang.customer') }}" name="contact_id" required>
                        <option value=""></option>
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-select form-select-solid" data-control="select2" data-placeholder="{{ __('projectx::lang.location') }}" name="location_id" id="projectx_location_id" required>
                        <option value=""></option>
    ...
    <div class="card card-flush mb-6">
        <div class="card-header pt-7 d-flex justify-content-between align-items-center">
            <h3 class="card-title fw-bold text-gray-900">{{ __('projectx::lang.sale_items') }}</h3>
        ...
        <div class="card-body pt-5">
                ...
                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" id="projectx_order_lines_table">
                    <thead>
                        <tr class="fw-bold text-muted text-uppercase fs-7">
                            <th class="min-w-250px">{{ __('projectx::lang.product_name') }}</th>
                            <th class="min-w-120px">{{ __('projectx::lang.quantity') }}</th>
                            <th class="min-w-150px">{{ __('projectx::lang.unit_price_short') }}</th>
                            <th class="min-w-120px">{{ __('projectx::lang.tax') }}</th>
                            <th class="min-w-120px">{{ __('projectx::lang.subtotal') }}</th>
                            <th class="text-end min-w-100px">{{ __('projectx::lang.action') }}</th>
                        </tr>
                    </thead>
            ...
            <div class="text-danger fs-7 mt-3 d-none" id="projectx_line_error">{{ __('projectx::lang.at_least_one_line_required') }}</div>
        </div>
    </div>
    ...
    <div class="row g-5 mb-6">
        <div class="col-xl-8">
            <div class="card card-flush h-100">
                <div class="card-header pt-7">
                    <h3 class="card-title fw-bold text-gray-900">{{ __('projectx::lang.discount_tax_and_totals') }}</h3>
                </div>
                <div class="card-body pt-5">
                    <div class="row g-5">
                        <div class="col-md-4">
                            <label class="form-label required">{{ __('projectx::lang.discount_type') }}</label>
                            <select class="form-select form-select-solid" name="discount_type" id="projectx_discount_type" required>
                                <option value="fixed" {{ old('discount_type', $transaction->discount_type ?? 'fixed') === 'fixed' ? 'selected' : '' }}>{{ __('projectx::lang.fixed') }}</option>
                                <option value="percentage" {{ old('discount_type', $transaction->discount_type ?? 'fixed') === 'percentage' ? 'selected' : '' }}>{{ __('projectx::lang.percentage') }}</option>
                            </select>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label required">{{ __('projectx::lang.discount_amount') }}</label>
                        ...
                        <div class="col-md-4">
                            <label class="form-label">{{ __('projectx::lang.order_tax') }}</label>
                    ...
                    <div class="d-flex flex-column gap-2 text-end">
                        <div><span class="text-gray-600">{{ __('projectx::lang.subtotal') }}:</span> <span class="fw-bold text-gray-900" id="projectx_subtotal_display">0.00</span></div>
                        <div><span class="text-gray-600">{{ __('projectx::lang.discount') }}:</span> <span class="fw-bold text-gray-900" id="projectx_discount_display">0.00</span></div>
                        <div><span class="text-gray-600">{{ __('projectx::lang.tax') }}:</span> <span class="fw-bold text-gray-900" id="projectx_tax_display">0.00</span></div>
                        <div><span class="text-gray-600">{{ __('projectx::lang.shipping_charges') }}:</span> <span class="fw-bold text-gray-900" id="projectx_shipping_display">0.00</span></div>
                        <div><span class="text-gray-600">{{ __('projectx::lang.additional_expense') }}:</span> <span class="fw-bold text-gray-900" id="projectx_expense_display">0.00</span></div>
                        <div class="fs-4"><span class="text-gray-800">{{ __('projectx::lang.grand_total') }}:</span> <span class="fw-bolder text-gray-900" id="projectx_final_total_display">0.00</span></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xl-4">
            <div class="card card-flush h-100">
                <div class="card-header pt-7">
                    <h3 class="card-title fw-bold text-gray-900">{{ __('projectx::lang.notes') }}</h3>
                </div>
                <div class="card-body pt-5">
                    <label class="form-label">{{ __('projectx::lang.sale_note') }}</label>
    ...
    <div class="card card-flush mb-6">
        <div class="card-header pt-7 d-flex justify-content-between align-items-center">
            <h3 class="card-title fw-bold text-gray-900">{{ __('projectx::lang.payment_info') }}</h3>
            <button type="button" class="btn btn-light-primary btn-sm" id="projectx_add_payment_btn">
                <i class="ki-duotone ki-plus fs-5 me-1"><span class="path1"></span><span class="path2"></span></i>
                {{ __('projectx::lang.add_payment') }}
            </button>
        </div>
        <div class="card-body pt-5">
            <div class="table-responsive">
    ...
    <div class="card card-flush mb-6">
        <div class="card-header pt-7">
            <h3 class="card-title fw-bold text-gray-900">{{ __('projectx::lang.shipping_details') }}</h3>
        </div>
        <div class="card-body pt-5">
            <div class="row g-5">
                <div class="col-md-6">
                    <label class="form-label">{{ __('projectx::lang.shipping_details') }}</label>
                ...
                <div class="col-md-6">
                    <label class="form-label">{{ __('projectx::lang.shipping_address') }}</label>
                ...
                <div class="col-md-4">
                    <label class="form-label">{{ __('projectx::lang.shipping_charges') }}</label>
                ...
                <div class="col-md-4">
                    <label class="form-label">{{ __('projectx::lang.shipping_status') }}</label>
                ...
                <div class="col-md-4">
                    <label class="form-label">{{ __('projectx::lang.shipping_custom_field_1') }}</label>
                ...
                <div class="col-md-4">
                    <label class="form-label">{{ __('projectx::lang.shipping_custom_field_2') }}</label>
                ...
                <div class="col-md-4">
                    <label class="form-label">{{ __('projectx::lang.shipping_custom_field_3') }}</label>
                ...
                <div class="col-md-4">
                    <label class="form-label">{{ __('projectx::lang.shipping_custom_field_4') }}</label>
                ...
                <div class="col-md-4">
                    <label class="form-label">{{ __('projectx::lang.shipping_custom_field_5') }}</label>
    ...
    <div class="card card-flush mb-6">
        <div class="card-header pt-7">
            <h3 class="card-title fw-bold text-gray-900">{{ __('projectx::lang.additional_expense') }}</h3>
        </div>
        <div class="card-body pt-5">
            <div class="row g-5">
                @for($i = 1; $i <= 4; $i++)
                    <div class="col-md-4">
                        <label class="form-label">{{ __('projectx::lang.expense_label') }} {{ $i }}</label>
                    ...
                    <div class="col-md-2">
                        <label class="form-label">{{ __('projectx::lang.amount') }}</label>
    ...
    <div class="d-flex justify-content-end gap-3">
        <a href="{{ route('projectx.sales.orders.show', ['id' => $transaction->id]) }}" class="btn btn-light">{{ __('projectx::lang.cancel') }}</a>
...
<script>
    (function () {
        ...
        const productSearchUrl = '{{ route('projectx.sales.orders.product_search') }}';
        ...
        const initProductSelect = (selectEl) => {
            ...
            $select.select2({
                width: '100%',
                placeholder: '{{ __('projectx::lang.search_products') }}',
