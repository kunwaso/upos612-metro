...
<head>
    ...
    <title>{{ __('projectx::lang.chat_shared_title') }}</title>
    ...
    <div class="container py-10">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title fw-bold">{{ $chatConversation->title ?: __('projectx::lang.new_chat') }}</h3>
                <div class="card-toolbar text-muted fs-7">{{ __('projectx::lang.chat_shared_read_only') }}</div>
            </div>
            <div class="card-body">
