...
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', $vasAccountingLocale ?? app()->getLocale()) }}">
	<!--begin::Head-->
	<head>
	<base href="{{ url('/') }}/" />
		...
		<meta property="og:locale" content="{{ str_replace('-', '_', $vasAccountingLocale ?? app()->getLocale()) }}" />
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-enabled">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="page d-flex flex-row flex-column-fluid">
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					<!--begin::Header-->
                    @include('layouts.partials.M-header')
					<!--end::Header-->
					@hasSection('toolbar')
						@yield('toolbar')
					@endif
					...
					<!--end::Container-->
					<!--begin::Footer-->
					@include('layouts.partials.M-footer')
					<!--end::Footer-->
				</div>
				<!--end::Wrapper-->
			</div>
		...
		@if(!empty($aiChatConfig) && !empty($aiChatConfig['enabled']))
			...
			<script>
				window.__aichatChatConfig = @json($aiChatConfig);
			</script>
			<script src="{{ asset('modules/aichat/js/custom/apps/chat/aichat-ai-chat.js') }}"></script>
		@else
			<div id="kt_drawer_chat"
				...
				data-kt-drawer-close="#kt_drawer_chat_close"></div>
		@endif
		<!--end::Chat drawer-->
		<!--begin::Chat drawer-->
