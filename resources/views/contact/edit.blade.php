        ...
        <div class="col-sm-4">
            <div class="form-group individual" @if($contact->contact_type == 'business') style="display: none;"  @endif>
                ...
                <div class="input-group">
                    ...
                    {!! Form::text('dob', !empty($contact->dob) ? format_date_value($contact->dob) : null, ['class' => 'form-control dob-date-picker','placeholder' => __('lang_v1.dob'), 'readonly']); !!}
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 customer_fields">
          <div class="form-group">
              ...
              <div class="input-group">
                  ...
                  {!! Form::text('credit_limit', $contact->credit_limit != null ? num_format_value($contact->credit_limit) : null, ['class' => 'form-control input_number']); !!}
              </div>
