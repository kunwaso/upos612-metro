    ...
    <tr @if(!empty($purchase_order_line)) data-purchase_order_id="{{$purchase_order_line->transaction_id}}" @endif @if(!empty($purchase_requisition_line)) data-purchase_requisition_id="{{$purchase_requisition_line->transaction_id}}" @endif>
        ...
        <td>
            ...
            @if($product->enable_stock == 1)
                <br>
                <small class="text-muted" style="white-space: nowrap;">@lang('report.current_stock'): @if(!empty($variation->variation_location_details->first())) {{ num_format_value($variation->variation_location_details->first()->qty_available) }} @else 0 @endif {{ $product->unit->short_name }}</small>
            @endif
        ...
        <td>
            ...
            <input type="text" 
                ...
                value="{{ format_quantity_value($quantity_value) }}"
            ...
            @if(!empty($product->second_unit))
                ...
                @if($secondary_unit_quantity !== '')value="{{ format_quantity_value($secondary_unit_quantity) }}" @endif
        ...
        <td>
            ...
            @if(!empty($last_purchase_line))
                ...
                <small class="text-muted">
                    ...
                    {{ num_format_value($last_purchase_line->discount_percent) }}%
                </small>
            @endif
        </td>
        <td>
