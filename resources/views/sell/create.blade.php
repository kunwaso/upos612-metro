...
@section('title', $create_page_title)

@section('content')
<div class="no-print pb-10">
<div class="d-flex flex-wrap flex-stack pb-5 mb-5">
	<h1 class="fs-2 fw-bold text-gray-900">{{ $create_page_title }}</h1>
</div>
	...
	<div class="card-body py-4">
		<div class="row g-4 align-items-end">
			<div class="col-md-4 col-lg-3">
				<label class="form-label required">{{ __('business.business_location') }}</label>
				<div class="input-group input-group-solid">
					<span class="input-group-text">
						<i class="ki-duotone ki-geolocation fs-2"><span class="path1"></span><span class="path2"></span></i>
					</span>
					{!! Form::select('select_location_id', $business_locations, $default_location->id ?? null, ['class' => 'form-select form-select-solid',
...
<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
	...
	<div class="row g-5">
		<div class="col-12">
			<div class="card card-flush shadow-sm mb-5">
						...
						<div class="col-md-4">
							<div class="mb-5">
								...
								<div class="input-group input-group-solid">
									...
									{!! Form::select('price_group', $price_groups, $selected_price_group, ['class' => 'form-select form-select-solid select2', 'id' => 'price_group', 'style' => 'min-width: 0;']); !!}
									<span class="input-group-text">
					...
					<div class="col-md-4">
						<div class="mb-5">
							...
							<div class="input-group input-group-solid">
								...
								{!! Form::select('types_of_service_id', $types_of_service, null, ['class' => 'form-select form-select-solid', 'id' => 'types_of_service_id', 'style' => 'width: 100%;', 'placeholder' => __('lang_v1.select_types_of_service')]); !!}
								{!! Form::hidden('types_of_service_price_group', null, ['id' => 'types_of_service_price_group']) !!}
								<span class="input-group-text">
									@show_tooltip(__('lang_v1.types_of_service_help'))
								</span>
							</div>
							<p class="text-muted fs-7 mb-0 hide" id="price_group_text">@lang('lang_v1.price_group'): <span></span></p>
						</div>
					</div>
				@endif
				...
				@if(in_array('subscription', $enabled_modules))
					<div class="col-md-4 ms-md-auto">
						<div class="form-check form-check-custom form-check-solid mb-5">
							{!! Form::checkbox('is_recurring', 1, false, ['class' => 'form-check-input input-icheck', 'id' => 'is_recurring']); !!}
					...
					<div class="mb-5">
						...
						<div class="input-group input-group-solid">
							...
							{!! Form::select('contact_id',
								[], null, ['class' => 'form-select mousetrap', 'id' => 'customer_id', 'placeholder' => 'Enter Customer name / phone', 'required', 'style' => 'min-width: 0;']); !!}
						...
						<div class="text-danger fs-7 mt-2 hide contact_due_text"><strong>@lang('account.customer_due'):</strong> <span></span></div>
					</div>
				...
				<div class="col-md-3">
					...
					<div class="mb-5">
						...
						<div class="d-flex flex-wrap gap-2">
							{!! Form::number('pay_term_number', $walk_in_customer['pay_term_number'], ['class' => 'form-control form-control-solid', 'style' => 'max-width: 8rem;', 'placeholder' => __('contact.pay_term'), 'required' => $is_pay_term_required]); !!}
							{!! Form::select('pay_term_type',
								['months' => __('lang_v1.months'),
									'days' => __('lang_v1.days')],
									$walk_in_customer['pay_term_type'],
								['class' => 'form-select form-select-solid','placeholder' => __('messages.please_select'), 'required' => $is_pay_term_required, 'style' => 'max-width: 10rem;']); !!}
						</div>
					</div>
				</div>
				...
				<div class="col-md-3">
					...
					{!! Form::select('commission_agent',
								$commission_agent, null, ['class' => 'form-select form-select-solid select2', 'id' => 'commission_agent', 'required' => $is_commission_agent_required]); !!}
					</div>
				</div>
				@endif
				<div class="@if(!empty($commission_agent)) col-md-3 @else col-md-4 @endif">
					<div class="mb-5">
						...
						<div class="input-group input-group-solid">
							...
							{!! Form::text('transaction_date', $default_datetime, ['class' => 'form-control form-control-solid', 'readonly', 'required']); !!}
						</div>
					</div>
				</div>
				@if(!empty($status))
				...
				@else
					<div class="@if(!empty($commission_agent)) col-md-3 @else col-md-4 @endif">
						<div class="mb-5">
							...
							{!! Form::select('status', $statuses, null, ['class' => 'form-select form-select-solid select2', 'placeholder' => __('messages.please_select'), 'required']); !!}
						</div>
					</div>
				@endif
				...
				@endif
					...
					<div class="col-md-3">
						<div class="mb-5">
							{!! Form::label('invoice_no', $sale_type == 'sales_order' ? __('restaurant.order_no') : __('sale.invoice_no') . ':', ['class' => 'form-label']) !!}
							{!! Form::text('invoice_no', null, ['class' => 'form-control form-control-solid', 'placeholder' => $sale_type == 'sales_order' ? __('restaurant.order_no') : __('sale.invoice_no')]); !!}
		        ...
		        @if(!empty($custom_field_1_label))
		        	...
		        	<div class="col-md-4">
				        <div class="mb-5">
				            ...
				            {!! Form::text('custom_field_1', null, ['class' => 'form-control form-control-solid','placeholder' => $custom_field_1_label, 'required' => $is_custom_field_1_required]); !!}
				        </div>
				    </div>
		        @endif
		        @if(!empty($custom_field_2_label))
		        	...
		        	<div class="col-md-4">
				        <div class="mb-5">
				            ...
				            {!! Form::text('custom_field_2', null, ['class' => 'form-control form-control-solid','placeholder' => $custom_field_2_label, 'required' => $is_custom_field_2_required]); !!}
				        </div>
				    </div>
		        @endif
		        @if(!empty($custom_field_3_label))
		        	...
		        	<div class="col-md-4">
				        <div class="mb-5">
				            ...
				            {!! Form::text('custom_field_3', null, ['class' => 'form-control form-control-solid','placeholder' => $custom_field_3_label, 'required' => $is_custom_field_3_required]); !!}
				        </div>
				    </div>
		        @endif
		        @if(!empty($custom_field_4_label))
		        	...
		        	<div class="col-md-4">
				        <div class="mb-5">
				            ...
				            {!! Form::text('custom_field_4', null, ['class' => 'form-control form-control-solid','placeholder' => $custom_field_4_label, 'required' => $is_custom_field_4_required]); !!}
				        </div>
				    </div>
		        @endif
		        <div class="col-md-4">
		        ...
		        @if((!empty($pos_settings['enable_sales_order']) && $sale_type != 'sales_order') || $is_order_request_enabled)
					<div class="col-md-4">
						<div class="mb-5">
							...
							{!! Form::select('sales_order_ids[]', [], null, ['class' => 'form-select form-select-solid select2', 'multiple', 'id' => 'sales_order_ids']); !!}
						</div>
					</div>
				@endif
				@if(in_array('tables' ,$enabled_modules) || in_array('service_staff' ,$enabled_modules))
		        	<div class="col-12"><span id="restaurant_module_span"></span></div>
		        @endif
				</div>
				</div>
			</div>
				...
				<div class="row g-4">
					...
					<div class="col-12 col-lg-10 mx-auto">
						...
						<div class="input-group input-group-solid input-group-lg">
							...
							{!! Form::text('search_product', null, ['class' => 'form-control form-control-solid mousetrap', 'id' => 'search_product', 'placeholder' => __('lang_v1.search_product_placeholder'),
			...
			<div class="card card-flush shadow-sm mb-5">
				...
				<div class="col-md-4  @if($sale_type == 'sales_order') hide @endif">
			        <div class="mb-5">
			            ...
			            <div class="input-group input-group-solid">
			                ...
			                {!! Form::select('discount_type', ['fixed' => __('lang_v1.fixed'), 'percentage' => __('lang_v1.percentage')], 'percentage' , ['class' => 'form-select form-select-solid','placeholder' => __('messages.please_select'), 'required', 'data-default' => 'percentage']); !!}
			            </div>
			        </div>
			    </div>
			    @php
			    ...
			    <div class="col-md-4 @if($sale_type == 'sales_order') hide @endif">
			        <div class="mb-5">
			            ...
			            <div class="input-group input-group-solid">
			                ...
			                {!! Form::text('discount_amount', num_format_value($sales_discount), ['class' => 'form-control form-control-solid input_number', 'data-default' => $sales_discount, 'data-max-discount' => $max_discount, 'data-max-discount-error_msg' => __('lang_v1.max_discount_error_msg', ['discount' => $max_discount != '' ? num_format_value($max_discount) : '']) ]); !!}
			            </div>
			        </div>
			    </div>
			    <div class="col-md-4 @if($sale_type == 'sales_order') hide @endif d-flex align-items-end mb-5">
			    ...
			    <div class="col-12 p-5 rounded bg-light @if(session('business.enable_rp') != 1 || $sale_type == 'sales_order') hide @endif">
			    	...
			    	<div class="col-md-4">
				        <div class="mb-0">
				            ...
				            <div class="input-group input-group-solid">
				                ...
				                {!! Form::number('rp_redeemed_modal', 0, ['class' => 'form-control form-control-solid direct_sell_rp_input', 'data-amount_per_unit_point' => session('business.redeem_amount_per_unit_rp'), 'min' => 0, 'data-max_points' => 0, 'data-min_order_total' => session('business.min_order_total_for_redeem') ]); !!}
				                <input type="hidden" id="rp_name" value="{{session('business.rp_name')}}">
				            </div>
				        </div>
				    </div>
				    <div class="col-md-4 d-flex align-items-end">
				    	<p class="mb-0"><strong>@lang('lang_v1.available'):</strong> <span id="available_rp">0</span></p>
				    </div>
				    <div class="col-md-4 d-flex align-items-end">
				    	<p class="mb-0"><strong>@lang('lang_v1.redeemed_amount'):</strong> <span class="text-danger">(-)</span><span id="rp_redeemed_amount_text">0</span></p>
				    </div>
				    </div>
			    </div>
			    <div class="col-md-4  @if($sale_type == 'sales_order') hide @endif">
			    	<div class="mb-5">
			            ...
			            <div class="input-group input-group-solid">
			                ...
			                {!! Form::select('tax_rate_id', $taxes['tax_rates'], $default_sales_tax, ['placeholder' => __('messages.please_select'), 'class' => 'form-select form-select-solid', 'data-default'=> $default_sales_tax], $taxes['attributes']); !!}
							<input type="hidden" name="tax_calculation_amount" id="tax_calculation_amount"
							value="@if(empty($edit)) {{ num_format_value($business_details->tax_calculation_amount) }} @else {{ num_format_value($transaction->tax?->amount) }} @endif" data-default="{{$business_details->tax_calculation_amount}}">
			            </div>
			        </div>
			    </div>
			    <div class="col-md-4 ms-md-auto @if($sale_type == 'sales_order') hide @endif d-flex align-items-end mb-5">
			    	<div class="p-4 bg-light-info rounded w-100">
						...
						<span class="display_currency fw-bold" id="order_tax">0</span>
					</div>
			    </div>
			    <div class="col-md-12">
			    	<div class="mb-5">
						{!! Form::label('sell_note', __('sale.sell_note'), ['class' => 'form-label']) !!}
						{!! Form::textarea('sale_note', null, ['class' => 'form-control form-control-solid', 'rows' => 3]); !!}
					</div>
			    </div>
			...
			<div class="col-md-4">
				<div class="mb-5">
		            ...
		            {!! Form::textarea('shipping_details',null, ['class' => 'form-control form-control-solid','placeholder' => __('sale.shipping_details') ,'rows' => '3', 'cols'=>'30']); !!}
		        </div>
			</div>
			<div class="col-md-4">
				<div class="mb-5">
		            {!! Form::label('shipping_address', __('lang_v1.shipping_address'), ['class' => 'form-label']) !!}
		            {!! Form::textarea('shipping_address',null, ['class' => 'form-control form-control-solid','placeholder' => __('lang_v1.shipping_address') ,'rows' => '3', 'cols'=>'30']); !!}
		        </div>
			</div>
			<div class="col-md-4">
				<div class="mb-5">
					...
					{!!Form::text('shipping_charges',num_format_value(0.00),['class'=>'form-control form-control-solid input_number','placeholder'=> __('sale.shipping_charges')]);!!}
					</div>
				</div>
			</div>
			<div class="col-md-4">
			...
			<div class="col-md-4">
		        <div class="mb-5">
		            ...
		            {!! Form::text('delivered_to', null, ['class' => 'form-control form-control-solid','placeholder' => __('lang_v1.delivered_to')]); !!}
		        </div>
		    </div>
			<div class="col-md-4">
				<div class="mb-5">
					{!! Form::label('delivery_person', __('lang_v1.delivery_person') . ':', ['class' => 'form-label']) !!}
					{!! Form::select('delivery_person', $users, null, ['class' => 'form-select form-select-solid select2','placeholder' => __('messages.please_select')]); !!}
				</div>
			</div>
		    @php
			...
			<div class="col-lg-8 ms-lg-auto" id="additional_expenses_div" style="display: none;">
				<table class="table table-row-bordered align-middle gy-3">
					...
					<tbody>
						<tr>
							<td>
								{!! Form::text('additional_expense_key_1', null, ['class' => 'form-control form-control-solid', 'id' => 'additional_expense_key_1']); !!}
							</td>
							<td>
								{!! Form::text('additional_expense_value_1', 0, ['class' => 'form-control form-control-solid input_number', 'id' => 'additional_expense_value_1']); !!}
							</td>
						</tr>
						<tr>
							<td>
								{!! Form::text('additional_expense_key_2', null, ['class' => 'form-control form-control-solid', 'id' => 'additional_expense_key_2']); !!}
							</td>
							<td>
								{!! Form::text('additional_expense_value_2', 0, ['class' => 'form-control form-control-solid input_number', 'id' => 'additional_expense_value_2']); !!}
							</td>
						</tr>
						<tr>
							<td>
								{!! Form::text('additional_expense_key_3', null, ['class' => 'form-control form-control-solid', 'id' => 'additional_expense_key_3']); !!}
							</td>
							<td>
								{!! Form::text('additional_expense_value_3', 0, ['class' => 'form-control form-control-solid input_number', 'id' => 'additional_expense_value_3']); !!}
							</td>
						</tr>
						<tr>
							<td>
								{!! Form::text('additional_expense_key_4', null, ['class' => 'form-control form-control-solid', 'id' => 'additional_expense_key_4']); !!}
							</td>
							<td>
								{!! Form::text('additional_expense_value_4', 0, ['class' => 'form-control form-control-solid input_number', 'id' => 'additional_expense_value_4']); !!}
							</td>
						</tr>
					</tbody>
				</table>
	        ...
	        @for($i; $i <= 6 ; $i++)
	            <div class="col-md-4 export_div" @if(empty($walk_in_customer['is_export'])) style="display: none;" @endif>
	                <div class="mb-5">
	                    ...
	                    {!! Form::text('export_custom_fields_info['.'export_custom_field_'.$i.']', !empty($walk_in_customer['export_custom_field_'.$i]) ? $walk_in_customer['export_custom_field_'.$i] : null, ['class' => 'form-control form-control-solid','placeholder' => __('lang_v1.export_custom_field'.$i), 'id' => 'export_custom_field_'.$i]); !!}
	                </div>
	            </div>
	        @endfor
			</div>
	...
	@if((empty($status) || (!in_array($status, ['quotation', 'draft'])) || $is_enabled_download_pdf) && $sale_type != 'sales_order')
		@can('sell.payments')
			<div class="card card-flush shadow-sm mb-5" @if(!empty($payment_body_id)) id="{{ $payment_body_id }}" @endif>
				<div class="card-header border-0 pt-5">
					<h3 class="card-title fw-bold fs-4 text-gray-800">@lang('purchase.add_payment')</h3>
				</div>
				<div class="card-body pt-0">
			@if($is_enabled_download_pdf)
				<div class="row g-4 mb-5 p-4 bg-light rounded">
					<div class="col-md-6">
						<div class="mb-5">
							...
							<div class="input-group input-group-solid">
								...
								{!! Form::select("prefer_payment_method", $payment_types, 'cash', ['class' => 'form-select form-select-solid','style' => 'width:100%;']); !!}
							</div>
						</div>
					</div>
					<div class="col-md-6">
						<div class="mb-5">
							...
							<div class="input-group input-group-solid">
								...
								{!! Form::select("prefer_payment_account", $accounts, null, ['class' => 'form-select form-select-solid','style' => 'width:100%;']); !!}
							</div>
						</div>
					</div>
				</div>
			...
			@if(empty($status) || !in_array($status, ['quotation', 'draft']))
                ...
                <div class="payment_row">
					...
					<div class="row hide payment_row g-4" id="change_return_payment_data">
						<div class="col-md-4">
							<div class="mb-5">
	...
	@endif
		...
		<div class="col-12 text-center py-5">
			<button type="button" id="submit-sell" class="btn btn-primary btn-lg me-3">@lang('messages.save')</button>
