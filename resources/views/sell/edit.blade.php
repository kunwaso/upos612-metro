		...
		<div class="col-md-12 col-sm-12">
			...
			@component('components.widget', ['class' => 'box-solid'])
			    ...
			    <div class="col-md-4 @if($transaction->type == 'sales_order') hide @endif">
			        <div class="form-group">
			            ...
			            <div class="input-group">
			                ...
			                {!! Form::text('discount_amount', num_format_value($transaction->discount_amount), ['class' => 'form-control input_number', 'data-default' => $business_details->default_sales_discount, 'data-max-discount' => $max_discount, 'data-max-discount-error_msg' => __('lang_v1.max_discount_error_msg', ['discount' => $max_discount != '' ? num_format_value($max_discount) : '']) ]); !!}
			            </div>
			        </div>
			    </div>
			    ...
			    <div class="col-md-12 well well-sm bg-light-gray @if(session('business.enable_rp') != 1 || $transaction->type == 'sales_order') hide @endif">
				    ...
				    <div class="col-md-4">
				    	<p><strong>@lang('lang_v1.redeemed_amount'):</strong> (-)<span id="rp_redeemed_amount_text">{{ num_format_value($transaction->rp_redeemed_amount) }}</span></p>
				    </div>
			    </div>
			    <div class="clearfix"></div>
			    <div class="col-md-4 @if($transaction->type == 'sales_order') hide @endif">
			    	<div class="form-group">
			            ...
			            <div class="input-group">
							...
							value="{{ num_format_value($transaction->tax?->amount) }}" data-default="{{$business_details->tax_calculation_amount}}">
			            </div>
			        </div>
			    </div>
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					{!!Form::text('shipping_charges',num_format_value($transaction->shipping_charges),['class'=>'form-control input_number','placeholder'=> __('sale.shipping_charges')]);!!}
					</div>
				</div>
			</div>
			<div class="clearfix"></div>
				...
				<table class="table table-condensed">
					...
					<tbody>
						<tr>
							...
							<td>
								{!! Form::text('additional_expense_value_1', num_format_value($transaction->additional_expense_value_1), ['class' => 'form-control input_number', 'id' => 'additional_expense_value_1']); !!}
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								{!! Form::text('additional_expense_value_2', num_format_value($transaction->additional_expense_value_2), ['class' => 'form-control input_number', 'id' => 'additional_expense_value_2']); !!}
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								{!! Form::text('additional_expense_value_3', num_format_value($transaction->additional_expense_value_3), ['class' => 'form-control input_number', 'id' => 'additional_expense_value_3']); !!}
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								{!! Form::text('additional_expense_value_4', num_format_value($transaction->additional_expense_value_4), ['class' => 'form-control input_number', 'id' => 'additional_expense_value_4']); !!}
							</td>
						</tr>
					</tbody>
				</table>
