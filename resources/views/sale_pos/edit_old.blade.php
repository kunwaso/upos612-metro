						...
						<div class="col-md-4 col-sm-6">
							<div class="form-group">
								...
								<div class="input-group">
									...
									{!! Form::text('transaction_date', format_datetime_value($transaction->transaction_date), ['class' => 'form-control', 'readonly', 'required']); !!}
								</div>
							</div>
						</div>
						@endif
							...
							<div class="col-md-4 col-sm-6">
								<div class="form-group">
									<div class="input-group">
										...
										{!! Form::text('exchange_rate', num_format_value($transaction->exchange_rate), ['class' => 'form-control input-sm input_number', 'placeholder' => __('lang_v1.currency_exchange_rate'), 'id' => 'exchange_rate']); !!}
									</div>
								</div>
							</div>
						@endif
