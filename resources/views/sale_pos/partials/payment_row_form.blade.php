	...
	<div class="{{$col_class}}">
		<div class="form-group">
			...
			<div class="input-group">
				...
				{!! Form::text("payment[$row_index][amount]", num_format_value($payment_line['amount']), ['class' => 'form-control payment-amount input_number', 'required', 'id' => "amount_$row_index", 'placeholder' => __('sale.amount'), 'readonly' => $readonly]); !!}
			</div>
		</div>
	</div>
	@if(!empty($show_date))
	<div class="{{$col_class}}">
		<div class="form-group">
			...
			<div class="input-group">
              ...
              {!! Form::text("payment[$row_index][paid_on]", isset($payment_line['paid_on']) ? format_datetime_value($payment_line['paid_on']) : format_datetime_value('now'), ['class' => 'form-control paid_on', 'readonly', 'required']); !!}
            </div>
		</div>
	</div>
	@endif
                    ...
                    <table class="table table-slim">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="text-left">
                            <span class="denomination_subtotal">{{ num_format_value($sub_total) }}</span>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
                      <tfoot>
                        <tr>
                          ...
                          <td>
                            <span class="denomination_total">{{ num_format_value($total) }}</span>
