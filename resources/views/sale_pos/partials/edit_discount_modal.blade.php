			...
			<div class="modal-body">
				    ...
				    <div class="col-md-6">
				        <div class="form-group">
				            ...
				            <div class="input-group">
				                ...
				                {!! Form::text('discount_amount_modal', num_format_value($sales_discount), ['class' => 'form-control input_number', 'data-max-discount' => $max_discount, 'data-max-discount-error_msg' => __('lang_v1.max_discount_error_msg', ['discount' => $max_discount != '' ? num_format_value($max_discount) : '']) ]); !!}
				            </div>
				        </div>
				    </div>
				</div>
				...
				<div class="row @if(!$is_rp_enabled) hide @endif">
				    ...
				    <div class="col-md-6">
				    	...
				    	<h5><strong>@lang('lang_v1.redeemed_amount'):</strong> <span id="rp_redeemed_amount_text">{{ num_format_value($rp_redeemed_amount) }}</span></h5>
				    </div>
				    </div>
				</div>
			</div>
