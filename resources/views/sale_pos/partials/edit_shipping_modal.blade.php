				    ...
				    <div class="col-md-6">
				        <div class="form-group">
				            ...
				            <div class="input-group">
				                ...
				                {!! Form::text('shipping_charges_modal', !empty($transaction->shipping_charges) ? num_format_value($transaction->shipping_charges) : 0, ['class' => 'form-control input_number input_number', 'data-decimal' => 'no_neg', 'placeholder' => __('sale.shipping_charges')]); !!}
				            </div>
				        </div>
				    </div>
