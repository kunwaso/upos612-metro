...
<div id="kt_toolbar" class="toolbar py-3 py-lg-5 no-print">
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
        <div class="page-title d-flex flex-column align-items-start me-3 py-2 gap-2">
            <h1 class="d-flex text-dark fw-bold fs-3 mb-0">{{ __('account.payment_account_report') }}</h1>
            <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
                ...
                <li class="breadcrumb-item text-gray-900">{{ __('account.payment_account_report') }}</li>
            </ul>
        </div>
    </div>
</div>
