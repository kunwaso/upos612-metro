...
<div id="kt_toolbar" class="toolbar py-3 py-lg-5 no-print">
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
        <div class="page-title d-flex flex-column align-items-start me-3 py-2 gap-2">
            <h1 class="d-flex text-dark fw-bold fs-3 mb-0">@lang('account.balance_sheet')</h1>
            <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
                ...
                <li class="breadcrumb-item text-gray-900">@lang('account.balance_sheet')</li>
            </ul>
        </div>
    </div>
</div>
<div class="d-flex flex-column-fluid align-items-start container-xxl">
        ...
        <div class="col-sm-12">
            ...
            <div class="col-sm-3 col-xs-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="end_date" value="{{ format_date_value('now') }}" class="form-control" readonly>
                    </div>
            </div>
            @endcomponent
        </div>
    ...
    <div class="box box-solid">
        <div class="box-header print_section">
            <h3 class="box-title">{{session()->get('business.name')}} - @lang( 'account.balance_sheet') - <span id="hidden_date">{{ format_date_value('now') }}</span></h3>
        </div>
        <div class="box-body">
