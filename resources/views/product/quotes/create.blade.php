        ...
        <div class="card-body pt-5">
            <div class="row g-5 projectx-quote-header-selects">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control form-control-solid" name="shipment_port" list="shipment_port_list" value="{{ old('shipment_port') }}" placeholder="{{ __('product.shipment_port') }}">
