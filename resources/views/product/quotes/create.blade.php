...
@section('title', __('product.create_quote'))

@section('content')
<div class="d-flex flex-wrap flex-stack mb-6">
    <div>
        <h1 class="text-gray-900 fw-bold mb-1">{{ __('product.create_quote') }}</h1>
        <div class="text-muted fw-semibold fs-6">{{ __('product.create_multi_quote_help') }}</div>
    </div>
...
<form method="POST" action="{{ route('product.quotes.store') }}" id="projectx_quote_create_form">
    @csrf
    ...
    <div class="card card-flush mb-6">
        ...
        <div class="card-body pt-5">
            <div class="row g-5 projectx-quote-header-selects">
                <div class="col-md-4">
                    <label class="form-label required" for="quote_create_contact_id">{{ __('product.customer') }}</label>
                    <select class="form-select form-select-solid select2 projectx-solid-select2" name="contact_id" id="quote_create_contact_id" data-control="select2" data-placeholder="{{ __('product.customer') }}" data-allow-clear="true">
                ...
                <div class="col-md-4">
                    <label class="form-label required" for="quote_create_location_id">{{ __('product.location') }}</label>
                    <select class="form-select form-select-solid select2 projectx-solid-select2" name="location_id" id="quote_create_location_id" data-control="select2" data-placeholder="{{ __('product.location') }}" data-allow-clear="true">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control form-control-solid" id="kt_projectx_quote_create_quote_date" name="quote_date" value="{{ old('quote_date', now()->format('Y-m-d')) }}" placeholder="{{ __('product.quote_date') }}">
                </div>
                <div class="col-md-4">
                    <label class="form-label required">{{ __('product.valid_until') }}</label>
                    <input type="text" class="form-control form-control-solid" id="kt_projectx_quote_create_expires_at" name="expires_at" value="{{ old('expires_at', now()->addDays(14)->format('Y-m-d')) }}" placeholder="{{ __('product.valid_until') }}">
                </div>
                <div class="col-md-4">
                    <label class="form-label">{{ __('product.shipment_port') }}</label>
                    <input type="text" class="form-control form-control-solid" id="quote_create_shipment_port" name="shipment_port" list="shipment_port_list" value="{{ old('shipment_port') }}" placeholder="{{ __('product.shipment_port') }}">
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control form-control-solid" name="remark" rows="6" placeholder="{{ __('product.remark') }}">{{ old('remark', config('product.quote_defaults.remark', '')) }}</textarea>
                </div>
            </div>
        </div>
    </div>
...
<script>
    (function () {
        ...
        const shipmentPortInput = document.getElementById('quote_create_shipment_port');
