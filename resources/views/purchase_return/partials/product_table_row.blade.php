<tr class="product_row">
    ...
    @if(session('business.enable_product_expiry'))
        <td>
            <input type="text" name="products[{{$row_index}}][exp_date]" class="form-control expiry_datepicker" value="@if(!empty($product->exp_date)){{ format_date_value($product->exp_date) }}@endif" readonly>
        </td>
    @endif
    <td>
        ...
        <input type="text" class="form-control product_quantity input_number input_quantity" value="{{ format_quantity_value($qty) }}" name="products[{{$row_index}}][quantity]" 
    ...
    <td>
        <input type="text" name="products[{{$row_index}}][unit_price]" class="form-control product_unit_price input_number" value="{{ num_format_value($purchase_price) }}">
    </td>
    <td>
        <input type="text" readonly name="products[{{$row_index}}][price]" class="form-control product_line_total" value="{{ num_format_value($qty*$purchase_price) }}">
    </td>
