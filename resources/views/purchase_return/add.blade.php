...
<div id="kt_toolbar" class="toolbar py-3 py-lg-5">
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
        <div class="page-title d-flex flex-column align-items-start me-3 py-2 gap-2">
            <h1 class="d-flex text-dark fw-bold fs-3 mb-0">@lang('lang_v1.purchase_return')</h1>
            <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
                ...
                <li class="breadcrumb-item text-gray-900">@lang('lang_v1.purchase_return')</li>
            </ul>
        </div>
    </div>
</div>
	...
	@component('components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.parent_purchase')])
		<div class="row">
			<div class="col-sm-4">
				...
				<strong>@lang('messages.date'):</strong> {{ format_date_value($purchase->transaction_date) }}
			</div>
			<div class="col-sm-4">
			        ...
			        <tbody>
			            ...
			            <tr>
			              	...
			              	<td>
					            ...
					            @endphp
					            <input type="text" name="returns[{{$purchase_line->id}}]" value="{{ format_quantity_value($purchase_line->quantity_returned) }}"
					            ...
					            @if($purchase_line->product->enable_stock) 
			              		...
			              		@endif
					            >
					            <input type="hidden" class="unit_price" value="{{ num_format_value($purchase_line->purchase_price_inc_tax) }}">
			              	</td>
			              	<td>
