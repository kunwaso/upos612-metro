    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="col-sm-6 col-xs-6">
            ...
            <strong>@lang('lang_v1.return_date'):</strong> {{ format_date_value($purchase->return_parent->transaction_date) }}<br>
        ...
        @else
            <div class="col-sm-6 col-xs-6">
                <h4>@lang('lang_v1.purchase_return_details'):</h4>
                <strong>@lang('lang_v1.return_date'):</strong> {{ format_date_value($purchase->transaction_date) }}<br>
                <strong>@lang('purchase.supplier'):</strong> {!! $purchase->contact->contact_address !!} <br>
                <strong>@lang('purchase.business_location'):</strong> {{ $purchase->location->name }}
            </div>
        @endif
        ...
        <div class="col-sm-12">
          ...
          <tbody>
              ...
              <tr>
                  ...
                  <td>{{ format_quantity_value($purchase_line->quantity_returned) }} {{$unit_name}}</td>
                  <td>
                    @php
