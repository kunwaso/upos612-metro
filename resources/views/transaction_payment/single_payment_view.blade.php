<div class="modal-dialog" role="document">
  <div class="modal-content">
      ...
      <div class="row">
          ...
          <div class="col-xs-6">
            <b>@lang('purchase.ref_no'):</b> 
              ...
              @endif
              <br/>
            <b>@lang('lang_v1.paid_on'):</b> {{ format_datetime_value($single_payment_line->paid_on) }}<br/>
            <br>
    ...
    <div class="modal-footer">
      ...
      <button type="button" class="btn btn-sm btn-light no-print" data-bs-dismiss="modal" data-dismiss="modal">@lang( 'messages.close' )
      </button>
    </div>
  </div>
</div>
