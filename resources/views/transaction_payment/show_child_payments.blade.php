<table class="table table-condensed bg-gray">
  ...
  @forelse ($child_payments as $payment)
    <tr>
      ...
      @endif</td>
      <td class="no-print">
        <button type="button" class="btn btn-sm btn-light-info view_payment" data-href="{{ action([\App\Http\Controllers\TransactionPaymentController::class, 'viewPayment'], [$payment->id]) }}" >@lang("messages.view")
                    </button>
      </td>
    </tr>
  @empty
