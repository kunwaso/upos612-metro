<tr class="product_row">
    ...
    <td>
        ...
        <input type="text" class="form-control product_quantity input_number input_quantity" value="{{ format_quantity_value($product->quantity_ordered) }}" name="products[{{$row_index}}][quantity]" 
    ...
    <td class="show_price_with_permission">
        <input type="text" name="products[{{$row_index}}][unit_price]" class="form-control product_unit_price input_number" value="{{ num_format_value($product->last_purchased_price) }}">
    </td>
    <td class="show_price_with_permission">
        <input type="text" readonly name="products[{{$row_index}}][price]" class="form-control product_line_total" value="{{ num_format_value($product->quantity_ordered*$product->last_purchased_price) }}">
    </td>
