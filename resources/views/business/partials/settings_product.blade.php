        ...
        <div class="col-sm-4 @if(!$business->enable_product_expiry) hide @endif" id="on_expiry_div">
            <div class="form-group">
                <div class="multi-input">
                    ...
                    {!! Form::number('stop_selling_before', $business->stop_selling_before, array_merge(
                        ['class' => 'form-control pull-left', 'placeholder' => 'stop n days before', 'style' => 'width:40%;', 'required' => true, 'id' => 'stop_selling_before'],
                        $business->on_product_expiry == 'keep_selling' ? ['disabled' => 'disabled'] : []
                    )); !!}
                </div>
            </div>
        </div>
