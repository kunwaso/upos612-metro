<div class="pos-tab-content">
    ...
    <div class="row">
        <div class="col-xs-3">
            <div class="form-group">
                ...
                {!! Form::select('sms_settings[sms_service]', ['nexmo' => 'Nexmo', 'twilio' => 'Twilio', 'other' => __('lang_v1.other')], $sms_settings['sms_service'] ?? 'other', ['class' => 'form-control', 'id' => 'sms_service']); !!}
            </div>
        </div>
    </div>
    <div class="row sms_service_settings @if(($sms_settings['sms_service'] ?? 'other') != 'nexmo') hide @endif" data-service="nexmo">
        <div class="col-xs-3">
            <div class="form-group">
    ...
    <div class="row sms_service_settings @if(($sms_settings['sms_service'] ?? 'other') != 'twilio') hide @endif" data-service="twilio">
        <div class="col-xs-3">
            <div class="form-group">
    ...
    <div class="row sms_service_settings @if(($sms_settings['sms_service'] ?? 'other') != 'other') hide @endif" data-service="other">
        <div class="col-xs-4">
            <div class="form-group">
