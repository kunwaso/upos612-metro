        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::text('default_sales_discount', number_format((float) ($business->default_sales_discount ?? 0), session('business.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), ['class' => 'form-control input_number']); !!}
                </div>
            </div>
        </div>
