...
<div class="row well">
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            {!! Form::text('amount_for_unit_rp', number_format((float) ($business->amount_for_unit_rp ?? 0), session('business.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), ['class' => 'form-control input_number','placeholder' => __('lang_v1.amount_for_unit_rp')]); !!}
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group">
            ...
            {!! Form::text('min_order_total_for_rp', number_format((float) ($business->min_order_total_for_rp ?? 0), session('business.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), ['class' => 'form-control input_number','placeholder' => __('lang_v1.min_order_total_for_rp')]); !!}
        </div>
    </div>
   ...
   <div class="row well">
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            {!! Form::text('redeem_amount_per_unit_rp', number_format((float) ($business->redeem_amount_per_unit_rp ?? 0), session('business.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), ['class' => 'form-control input_number','placeholder' => __('lang_v1.redeem_amount_per_unit_rp')]); !!}
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group">
            ...
            {!! Form::text('min_order_total_for_redeem', number_format((float) ($business->min_order_total_for_redeem ?? 0), session('business.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), ['class' => 'form-control input_number','placeholder' => __('lang_v1.min_order_total_for_redeem')]); !!}
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group">
