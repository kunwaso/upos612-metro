     ...
     <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::select('common_settings[default_datatable_page_entries]', [25 => 25, 50 => 50, 100 => 100, 200 => 200, 500 => 500, 1000 => 1000, -1 => __('lang_v1.all')], !empty($common_settings['default_datatable_page_entries']) ? $common_settings['default_datatable_page_entries'] : 25 , 
