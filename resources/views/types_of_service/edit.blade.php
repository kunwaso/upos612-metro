    ...
    <div class="modal-body">
      ...
      <div class="form-group col-md-6">
        {!! Form::label('packing_charge', __( 'lang_v1.packing_charge' ) . ':') !!}
          {!! Form::text('packing_charge', !empty($type_of_service->packing_charge) ? num_format_value($type_of_service->packing_charge) : '', ['class' => 'form-control input_number', 'placeholder' => __( 'lang_v1.packing_charge' )]); !!}
      </div>
      <div class="form-group col-md-12">
          <div class="checkbox">
            <label>
