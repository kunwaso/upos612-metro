  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
            ...
            <div class="form-group">
                ...
                {!! Form::text('amount', num_format_value($account_transaction->amount), ['class' => 'form-control input_number', 'required','placeholder' => __( 'sale.amount' ) ]); !!}
            </div>
            @if($account_transaction->sub_type == 'deposit')
            @php
            ...
            <div class="form-group">
                ...
                <div class="input-group date">
                  {!! Form::text('operation_date', format_datetime_value($account_transaction->operation_date), ['class' => 'form-control', 'required','placeholder' => __( 'messages.date' ), 'id' => 'od_datetimepicker' ]); !!}
