<tr class="product_row">
	...
	<td>
		...
		<input type="text" class="w-auto form-control pos_quantity input_number mousetrap" value="{{ num_format_value($product->quantity_ordered) }}" name="products[{{$row_count}}][quantity]" 
	...
	<td>
		<input type="text" name="products[{{$row_count}}][unit_price]" class="form-control pos_unit_price input_number mousetrap" value="{{ num_format_value($product->default_sell_price) }}">
	</td>
	@php
		$hide_tax = 'hide';
	...
	<td class="{{$hide_tax}}">
		<input type="text" name="products[{{$row_count}}][unit_price_inc_tax]" class="form-control pos_unit_price_inc_tax input_number" value="{{ num_format_value($unit_price_inc_tax) }}">
	</td>
	<td>
		<input type="text" readonly name="products[{{$row_count}}][price]" class="form-control pos_line_total" value="{{ num_format_value($product->quantity_ordered*$unit_price_inc_tax) }}">
	</td>
