...
<div id="kt_toolbar" class="toolbar py-3 py-lg-5 no-print">
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
        <div class="page-title d-flex flex-column align-items-start me-3 py-2 gap-2">
            <h1 class="d-flex text-dark fw-bold fs-3 mb-0">@lang('lang_v1.sell_return')</h1>
            <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
                ...
                <li class="breadcrumb-item text-gray-900">@lang('lang_v1.sell_return')</li>
            </ul>
        </div>
    </div>
</div>
		...
		<div class="box-body">
			<div class="row">
				<div class="col-sm-4">
					...
					<strong>@lang('messages.date'):</strong> {{ format_date_value($sell->transaction_date) }}
				</div>
				<div class="col-sm-4">
				...
				<div class="col-sm-3">
					<div class="form-group">
						...
						<div class="input-group">
							...
							@endphp
							{!! Form::text('transaction_date', format_datetime_value($transaction_date), ['class' => 'form-control', 'readonly', 'required']); !!}
						</div>
					</div>
				</div>
				<div class="col-sm-12">
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="form-group">
						...
						{!! Form::text('discount_amount', num_format_value($discount_amount), ['class' => 'form-control input_number']); !!}
					</div>
				</div>
			</div>
			@php
...
@stop
@section('javascript')
<script src="{{ asset('assets/app/js/printer.js?v=' . $asset_v) }}"></script>
<script src="{{ asset('assets/app/js/sell_return.js?v=' . $asset_v) }}"></script>
