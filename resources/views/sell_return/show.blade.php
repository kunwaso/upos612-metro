...
<div class="modal-body">
   <div class="row">
      <div class="col-sm-6 col-xs-6">
        ...
        <strong>@lang('lang_v1.return_date'):</strong> {{ format_date_value($sell->return_parent->transaction_date) }}<br>
      ...
      <div class="col-sm-12">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ format_quantity_value($sell_line->quantity_returned) }} {{$unit_name}}</td>
                <td>
                  @php
