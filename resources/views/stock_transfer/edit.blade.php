...
<div id="kt_toolbar" class="toolbar py-3 py-lg-5 no-print">
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
        <div class="page-title d-flex flex-column align-items-start me-3 py-2 gap-2">
            <h1 class="d-flex text-dark fw-bold fs-3 mb-0">@lang('lang_v1.edit_stock_transfer')</h1>
            <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
                ...
                <li class="breadcrumb-item text-gray-900">@lang('lang_v1.edit_stock_transfer')</li>
            </ul>
        </div>
    </div>
</div>
				...
				<div class="col-sm-4">
					<div class="form-group">
						...
						<div class="input-group">
							...
							{!! Form::text('transaction_date', format_datetime_value($sell_transfer->transaction_date), ['class' => 'form-control', 'readonly', 'required']); !!}
						</div>
					</div>
				</div>
				<div class="col-sm-4">
			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					...
					id="stock_adjustment_product_table">
						...
						<tfoot>
							<tr class="text-center show_price_with_permission"><td colspan="3"></td><td><div class="pull-right"><b>@lang('sale.total'):</b> <span id="total_adjustment">{{ num_format_value($subtotal) }}</span></div></td></tr>
						</tfoot>
					</table>
	...
	@component('components.widget', ['class' => 'box-solid'])
			<div class="row">
				<div class="col-sm-4">
					<div class="form-group">
							...
							{!! Form::text('shipping_charges', num_format_value($sell_transfer->shipping_charges), ['class' => 'form-control input_number', 'placeholder' => __('lang_v1.shipping_charges')]); !!}
					</div>
				</div>
				<div class="col-sm-4">
					<div class="form-group">
			...
			<div class="row">
				<div class="col-md-12 text-right show_price_with_permission">
					...
					<b>@lang('stock_adjustment.total_amount'):</b> <span id="final_total_text">{{ num_format_value($final_total) }}</span>
				</div>
				<br>
				<br>
