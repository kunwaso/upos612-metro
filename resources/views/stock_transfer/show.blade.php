				      ...
				      <table class="table bg-gray">
				        ...
				        @foreach($sell_transfer->sell_lines as $sell_lines)
				          <tr>
				            ...
				            <td>{{ format_quantity_value($sell_lines->quantity) }} @if(!empty($sell_lines->sub_unit)) {{$sell_lines->sub_unit->short_name}} @else {{$sell_lines->product->unit->short_name}} @endif</td>
